...
using BlazorSozluk.Api.Application.Features.Entry.Queries;
using MediatR;
...
namespace AYDSozluk.Api.WebApi.Controllers
{
    ...
    public class EntryController : BaseController
    {
        ...
        [Route("CreateEntry")]
        [Authorize]
        public async Task<IActionResult> CreateEntry([FromBody] CreateEntryRequest command)
        {
        ...
        [Authorize]
        public async Task<IActionResult> CreateEntryComment([FromBody] CreateEntryCommentRequest command)
        {
            if (!command.CreatedById.HasValue)
                command.CreatedById = UserId;
