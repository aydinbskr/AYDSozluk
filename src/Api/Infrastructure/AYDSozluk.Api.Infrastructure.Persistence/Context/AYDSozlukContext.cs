...
namespace AYDSozluk.Api.Infrastructure.Persistence.Context
{
    public class AYDSozlukContext : DbContext
    {
        public const string DEFAULT_SCHEMA = "dbo";

        public AYDSozlukContext()
        {

        }

        public AYDSozlukContext(DbContextOptions options) : base(options)
        {
        }
